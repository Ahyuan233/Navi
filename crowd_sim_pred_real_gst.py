...
class CrowdSimPredRealGST(CrowdSimPred):
    ...
    def render(self, mode='human'):
        ...
        # add walls #####################################################################################################################################################################
        vertical_line_1 = mlines.Line2D([-2.5, -2.5], [5, 10], color='black', linestyle='-', label='Vertical Line')
        ax.add_artist(vertical_line_1)
        artists.append(vertical_line_1)

        horizontal_line_1 = mlines.Line2D([-10, -2.5], [5, 5], color='black', linestyle='-', label='Horizontal Line')
        ax.add_artist(horizontal_line_1)
        artists.append(horizontal_line_1)

        vertical_line_2 = mlines.Line2D([2.5, 2.5], [5, 10], color='black', linestyle='-', label='Vertical Line')
        ax.add_artist(vertical_line_2)
        artists.append(vertical_line_2)

        horizontal_line_2 = mlines.Line2D([2.5, 10], [5, 5], color='black', linestyle='-', label='Horizontal Line')
        ax.add_artist(horizontal_line_2)
        artists.append(horizontal_line_2)

        vertical_line_3 = mlines.Line2D([-2.5, -2.5], [-10, 0], color='black', linestyle='-', label='Vertical Line')
        ax.add_artist(vertical_line_3)
        artists.append(vertical_line_3)

        horizontal_line_3 = mlines.Line2D([-10, -2.5], [0, 0], color='black', linestyle='-', label='Horizontal Line')
        ax.add_artist(horizontal_line_3)
        artists.append(horizontal_line_3)

        vertical_line_4 = mlines.Line2D([2.5, 2.5], [-10, 0], color='black', linestyle='-', label='Vertical Line')
        ax.add_artist(vertical_line_4)
        artists.append(vertical_line_4)

        horizontal_line_4 = mlines.Line2D([2.5, 10], [0, 0], color='black', linestyle='-', label='Horizontal Line')
        ax.add_artist(horizontal_line_4)
        artists.append(horizontal_line_4)
